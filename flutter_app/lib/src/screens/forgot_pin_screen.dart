  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(
      ...
      children: [
        ...
        TextField(controller: phone, enabled: !sent, keyboardType: TextInputType.phone, decoration: const InputDecoration(labelText: 'WhatsApp number', prefixText: '+91 ', prefixStyle: TextStyle(color: Colors.black, fontSize: 16, height: 1.2, fontWeight: FontWeight.w600), hintText: '9876543210')),
        if (sent) ...[
