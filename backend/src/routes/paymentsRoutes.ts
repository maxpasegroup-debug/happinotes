...
router.post('/test/activate', verifyLimiter, authenticate, activateTestSubscription);
router.post('/test/purchase-book', verifyLimiter, authenticate, purchaseBookInTestMode);
